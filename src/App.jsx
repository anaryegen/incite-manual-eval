...
export default function App() {
  ...
  return (
    <div className="container">
      ...
      <section className="section task-description">
        <p className="task-description-text">
          The goal of this evaluation is to measure the faithfullness and quality of the citations generated by Large Language Models.
          You are provided with the question, generated answer with citations and the reference document where the citation was drawn (highlighted in yellow)
          <p>Please evaluate each citation by answering two questions:</p>
          <p>(1) Does the text in <span style={{backgroundColor: '#bfdbfe', padding: '2px 4px', borderRadius: '3px'}}>Blue</span> support the highlighted statement in the <span style={{backgroundColor: '#fef08a', padding: '2px 4px', borderRadius: '3px'}}>Yellow</span>?</p>
          <p>(2) Is the text in <span style={{backgroundColor: '#fef08a', padding: '2px 4px', borderRadius: '3px'}}>Yellow</span> related to the text in <span style={{backgroundColor: '#bfdbfe', padding: '2px 4px', borderRadius: '3px'}}>Blue</span>?</p>
        </p>
      </section>
