    ...
    <div className="container">
      ...
      <section className="section task-description">
        <p className="task-description-text">
          ...
          <p>(1) Does the text in Blue support the highlighted statement in the yellow?</p>
          <p>(2) Is the text in yellow related to the text in blue?</p>
        </p>
      </section>
      ...
      <section className="section eval-section">
        <h2>Evaluation</h2>
        <EvalButtons
          label="1. Does the text in Blue support the highlighted statement in the yellow?"
          value={currentResponse.q1}
          onChange={(v) => setAnswer('q1', v)}
        />
        <EvalButtons
          label="2. Is the text in yellow related to the text in blue?"
